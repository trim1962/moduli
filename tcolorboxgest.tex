...
\newtcbtheorem [number within=chapter,crefname={esempio}{esempio},Crefname={Esempio}{Esempio}, list inside=thm]{esempiot}{Esempio}{esestyle}{exa}
\newtcbtheorem [number within=chapter,crefname={cesempio}{cesempio},Crefname={CEsempio}{CEsempio}, list inside=cthm]{cesempiot}{Contro esempio}{attstyle}{exa}
