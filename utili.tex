...
\newcommand{\testradianti}{\begin{center}
	...
	\end{center}}
%todo inizio
\usepackage[italian,colorinlistoftodos,textwidth=.8\marginparwidth]{todonotes}
...
\newcommand{\bassapriorita}[1]{\todo[color=green!40,inline]{#1}}
\newcommand{\mediapriorita}[1]{\todo[color=blue!40,inline]{#1}}
\newcommand{\altapriorita}[1]{\todo[color=red!40,inline]{#1}}
